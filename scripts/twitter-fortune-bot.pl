...
my $consumer_key = $ENV{FORTUNE_BOT_TWITTER_CONSUMER_KEY};
my $consumer_secret = $ENV{FORTUNE_BOT_TWITTER_CONSUMER_SECRET};
my $token = $ENV{FORTUNE_BOT_TWITTER_TOKEN};
my $token_secret = $ENV{FORTUNE_BOT_TWITTER_TOKEN_SECRET};
